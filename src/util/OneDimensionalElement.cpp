...
void OneDimensionalParentElement::Initialize(unsigned int polyOrderIn, bool lumpMassIn)
{
    ...
    else if (polyOrder == 3)
    {
        ...
        if (!lumpMass)
        {
            ...
            mpe[0][2] = mpe[2][0] = 99.0 * fact;
            mpe[0][3] = mpe[3][0] = -36.0 * fact;
            mpe[2][2] = mpe[3][3] = 648.0 * fact;
            mpe[1][2] = mpe[2][1] = -36.0 * fact;
            mpe[1][3] = mpe[3][1] = 99.0 * fact;
        ...
        kpe[0][2] = kpe[2][0] = -189.0 * fact;
        kpe[0][3] = kpe[3][0] = 54.0 * fact;
        kpe[2][2] = kpe[3][3] = 432.0 * fact;
        kpe[1][2] = kpe[2][1] = 54.0 * fact;
        kpe[1][3] = kpe[3][1] = -189.0 * fact;
        kpe[2][3] = kpe[3][2] = -297.0 * fact;

        // dN/dxi on the left side
        Be_leftNode[0] = -11.0/4.0;
        Be_leftNode[1] = 1.0/2.0;
        Be_leftNode[2] = 9.0/2.0;
        Be_leftNode[3] = -9.0/4.0;  

        // dN/dxi on the right side
        Be_rightNode[0] = -1.0/2.0;
        Be_rightNode[1] = 11.0/4.0;
        Be_rightNode[2] = 9.0/4.0;  
        Be_rightNode[3] = -9.0/2.0; 
    }
}
