...
void Break_nt_Matrix_n_t_components(bool computeInverse, const MAT &mat_nt, double &scalar_nn, VECm1 &vec_nt,
                                    VECm1 &vec_tn, MATm1 &mat_tt, MATm1 &mat_tt_condensed, MATm1 &mat_tt_condensed_Inv);
#endif
...
void ProductTransposeMatVec(const MAT &matA, const VEC &vecB, VEC &matATranspose_times_vecB);
...
void LinearCombination2Vecs(const VEC &vecA, const VEC &vecB, double factorA, double factorB, VEC &fAvecAplusfBvecB);
...
bool EigenValuesEigenVectors_PositiveSymMatrix(const MAT &mat, MAT &eigenVecsRowWise, VEC &eigenValues);
